"""
BA Discussions Router — stakeholder_discussions WHERE workflow_type='ba'
"""
...
async def create_discussion(
    ...
    row = await db.fetchrow("""
        ...
        VALUES ($1,$2,$3,'ba',$4,$5,$6,'open') RETURNING *
...
async def update_discussion(
    ...
    row = await db.fetchrow("""
        UPDATE stakeholder_discussions SET
            ...
            updated_at=NOW()
        WHERE id=$1 AND workflow_type='ba' RETURNING *
...
async def delete_discussion(
    ...
    await db.execute(
        "DELETE FROM stakeholder_discussions WHERE id=$1 AND workflow_type='ba'", disc_id
    )
